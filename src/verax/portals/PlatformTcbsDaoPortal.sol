...
import {PlatformTcbsDao, AttestationRequest} from "../../dao/PlatformTcbsDao.sol";

contract PlatformTcbsDaoPortal is PlatformTcbsDao, AbstractPortal {
    ...
    constructor(address[] memory modules, address router, address pck)
