...
help:
	...
	@echo "  clean           Remove build artifacts and address files"
	@echo ""
	...
	@echo ""
	@echo "Example usage:"
	@echo "  make deploy-all PRIVATE_KEY=xxx RPC_URL=xxx"
	@echo "  make verify-all PRIVATE_KEY=xxx RPC_URL=xxx ETHERSCAN_API_KEY=xxx"
