...
for key in X509CRLHelperV2 AutomataPcsDaoV2 AutomataPckDaoV2; do
...
if [[ "$deployed_contracts" -eq 3 ]]; then
    info "All three CRL V2 contracts already have code; validating bindings"
else
    ...
    info "Deploying X509CRLHelperV2, AutomataPcsDaoV2, and AutomataPckDaoV2"
